...
export async function generateOGImage(options: GenerateProps): Promise<ImageResponse> {
  const {title, description, icon, site, primaryColor, secondaryColor, primaryTextColor} = options;
