...
export function PageTOCTitle(props: ComponentProps<"h2">) {
  return (
    <h3 {...props} className={cn("inline-flex items-center gap-1.5 text-sm text-fd-muted-foreground", props.className)}>
...
export function PageTOCItems({variant = "normal", ...props}: ComponentProps<"div"> & {variant?: "clerk" | "normal"}) {
