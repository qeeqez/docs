...
const optionVariants = cva(
    'text-sm p-2 rounded-lg inline-flex items-center gap-2 cursor-pointer hover:text-fd-accent-foreground hover:bg-fd-muted-foreground/10 [&_svg]:size-4',
);
        ...
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent
              align="end"
                ...
                >
                          <span
                              className={cn("w-10 h-10 border border-fd-muted-foreground flex items-center justify-center rounded-lg")}>
                                <Copy/>
                          </span>
                    ...
                    <span className={cn("block")}>
                              ...
                              <span className={cn("text-xs text-fd-muted-foreground")}>Copy page as Markdown for LLMs</span>
                        </span>
                </div>
                {items.map((item) => (
                    <a
                    ...
                    >
                          ...
                          <span className={cn("block")}>
                              <span className={cn("flex gap-2 items-center font-medium")}>
                                  {item.title}
                                  <ExternalLinkIcon className="text-fd-muted-foreground size-3.5"/>
                              </span>

                              <span className={cn("text-xs text-fd-muted-foreground")}>{item.desc}</span>
                        </span>
                    </a>
                ))}
            </PopoverContent>
