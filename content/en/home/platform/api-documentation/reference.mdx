...
Complete reference for all RIXL API endpoints. For interactive testing and real-time examples, visit our [Interactive API Documentation](/en/home/platform/api-documentation/reference).
...
<Callout type="info">
  For complete interactive API documentation with live testing capabilities, visit our <a href="/en/home/platform/api-documentation/reference" className="underline">Interactive API Reference</a>.
</Callout>
