...
<Callout type="warn" title="Store Your Key Immediately">
  For security reasons, your API key is only shown to you <strong>once</strong> upon creation. You will not be able to retrieve it again.
</Callout>
...
## Related
- [Dashboard Projects Guide](/en/home/platform/dashboard/projects/overview)
- [API Reference](/en/home/platform/api-documentation/overview)