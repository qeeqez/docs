...
<Columns cols={3}>
  ...
  <Card
    ...
    href="/en/home/platform/dashboard/projects/create-project"
    icon="folder-plus"
  >
...
<Callout type="tip" title="Ready to integrate?">
  First, <a href="/en/home/platform/api-documentation/create-key" className="underline">grab your API keys</a> and <a href="/en/home/platform/dashboard/projects/overview" className="underline">set up a project</a>. Then you're just a few lines of code away from optimized media delivery.
</Callout>
...
<Callout type="info">
  For complete API documentation with interactive testing, visit our <a href="/en/home/platform/api-documentation/reference" className="underline">Interactive API Reference</a>.
</Callout>
