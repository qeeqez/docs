...
<Callout type="tip">
  Create separate projects for **different environments** (development, staging, production) or business units to keep
  data and access cleanly separated.
</Callout>
...
<Columns cols={3}>
  <Card title="Rename Project">
    Update the display name for easier identification
  </Card>
  <Card title="Change Optimization Tier">
...
<Callout type="error">
  **Warning**: Deleting a project is permanent and removes all content, feeds, and settings. This action cannot be
  undone.
</Callout>
