...
Use **API keys** to securely connect your [RIXL project](/en/home/platform/dashboard/projects/overview) with applications, workflows, or services.
...
<Steps>
  <Step>
    **Navigate to API Settings**
    ...
    In your [project dashboard](/en/home/platform/dashboard/projects/overview), go to **Settings → API Keys → Create New Key**.
  </Step>
...
<Callout type="info">
  Need help? See our [API troubleshooting guide](/en/home/platform/api-documentation/error-handling) or contact support.
</Callout>

## Related Resources

- **[API Access Settings](/en/home/platform/api-documentation/create-key)** - Complete API key management
- **[API Reference](/en/home/platform/api-documentation/overview)** - Full API documentation
- **[Project Settings](/en/home/platform/dashboard/projects/overview)** - Project-specific configurations
...
<Columns cols={3}>
  <Card
    ...
    href="/en/home/platform/api-documentation/reference"
  >
  ...
  <Card
    ...
    href="/en/home/platform/account-teams/security"
  >
