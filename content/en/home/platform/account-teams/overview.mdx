...
<Columns cols={3}>
  <Card
    ...
    href="/en/home/platform/account-teams/create-organization"
    icon="building"
  >
  ...
  <Card
    ...
    href="/en/home/platform/account-teams/team-management"
    icon="users"
  >
  ...
  <Card
    ...
    href="/en/home/platform/account-teams/membership"
    icon="user-check"
  >
...
<Columns cols={3}>
  ...
  <Card title="Admin" icon="shield">Creates and manages projects. Invites team members and configures settings.</Card>
...
<Callout type="tip">
  **Quick access:** Click your profile picture in the top-right corner and select **Account Settings** to jump straight
