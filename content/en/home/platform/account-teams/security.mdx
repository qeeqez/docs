...
<Steps>
  ...
  <Step>
    **Enable 2FA in RIXL**
    - Go to [Security Settings](/en/home/platform/account-teams/security)
...
- **[API Key](/en/home/platform/api-documentation/create-key) Usage**: Notifications for developer key activity
...
- **[API Access](/en/home/platform/api-documentation/create-key)** - Developer keys and security
