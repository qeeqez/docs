...
<Callout type="warn" title="Before Disconnecting">
  If you use a connected account as your only sign-in method, create a password for your RIXL account **before**
  disconnecting it to avoid being locked out.
</Callout>
...
<Steps>
  ...
  <Step>
    **Enable 2FA in RIXL**
    - Go to [Security Settings](/en/platform/account-teams/security)
...
<Steps>
  <Step>
    Go to **[Security Settings](/en/platform/account-teams/security) → Password**
  </Step>
...
- **[API Key](/en/platform/api-documentation/create-key) Usage**: Notifications for developer key activity
...
- **[General Settings](/en/platform/account-teams/general-settings)** - Profile and account information
- **[API Access](/en/platform/api-documentation/create-key)** - Developer keys and security
- **[Membership](/en/platform/account-teams/membership)** - Organization security roles