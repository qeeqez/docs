...
- Review [upload implementation](/platform/uploads/videos/upload-implementation) best practices
- Understand the [processing pipeline](/platform/uploads/videos-guide) for better troubleshooting
