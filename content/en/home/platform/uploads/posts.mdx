...
<Callout type="info">
  Feed posts require an existing feed. Learn about [creating feeds](/platform/dashboard/feeds/overview) if you haven't
  set one up yet.
</Callout>
...
- **`video_quality`** - For videos: "basic", "shorts", or "pro" (see [Quality Tiers](/platform/uploads/videos/quality-tiers) for details)
...
<Callout type="success">
  A successful response will return the complete Post object with all its details, confirming your new post is live in
  the feed.
</Callout>
...
**[API Reference](/platform/api-documentation/overview)** - Complete feed and post API documentation with all available parameters.