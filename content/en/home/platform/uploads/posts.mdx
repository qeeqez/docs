...
<Callout type="info">
  Feed posts require an existing feed. Learn about [creating feeds](/en/home/platform/dashboard/feeds/overview) if you haven't
  set one up yet.
</Callout>
...
**[API Reference](/en/home/platform/api-documentation/overview)** - Complete feed and post API documentation with all available parameters.