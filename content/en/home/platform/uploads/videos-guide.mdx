...
<Callout>
  Once [video upload](https://dash.rixl.com/videos) is complete, RIXL encodes the file into various quality levels and
...
<Columns cols={4}>
  ...
  >Audio served separately for efficient bandwidth usage</Card>
  <Card
    title="Other Support"
...
<Columns cols={4}>
  ...
  >Maintains native frame rates and adapts for target platforms</Card>
  <Card
...
<Columns cols={4}>
  ...
  >Standard rates for efficient processing and compatibility</Card>
  <Card
...
<Callout type="success">
  **RIXL's** video processing automatically prepares your content for all viewing scenarios,
