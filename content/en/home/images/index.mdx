...
<div className="mt-12">
  <Callout type="tip" title="Ready to see the difference?">
    Start with our [Dashboard Upload](/en/home/platform/uploads/images) to see AVIF transformation in action, or jump into the
    [React Component Guide](/en/sdk/image-component) to add delivered images to your application. For custom workflows,
    explore our [API Documentation](/en/home/platform/api-documentation/overview).
  </Callout>
</div>
