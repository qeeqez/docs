...
<div className="mt-12">
  <Callout type="tip" title="Ready to stream?">
    Start with our [Video Upload Guide](/en/platform/uploads/videos-guide) to see HLS streaming in action, or jump into the
    [React Component Guide](/en/sdk/video-component) to add professional video players to your application. For custom
    workflows, explore our [API Documentation](/en/platform/api-documentation/overview).
  </Callout>
</div>
