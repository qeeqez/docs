...
Choose the right [quality tier](/en/platform/uploads/videos/quality-tiers) based on your content and audience:
...
<Callout type="tip">
  ...
  [5-Minute Quick Start Guide](/en/getting-started/quick-start) or explore the
  [Platform Dashboard Guide](/en/platform/dashboard/guide) for more in-depth
  workflows.
</Callout>