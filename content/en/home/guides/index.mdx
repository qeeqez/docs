...
<Callout type="tip" title="Need inspiration?">
  Explore our [Best Practices](/en/getting-started/best-practices) for performance tips, check out the [Platform
  Documentation](/en/platform) for comprehensive features, or dive into the [API
  Reference](/en/platform/api-documentation/overview) for detailed technical documentation.
</Callout>