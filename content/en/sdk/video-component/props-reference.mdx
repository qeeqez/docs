...
The unique media identifier from your RIXL dashboard. Upload your video to [dash.rixl.com/videos](https://dash.rixl.com/videos) to get this ID.
...
- `'feed'` - Always-visible UI with expandable video description, mute button, and progress bar. Used internally by the Feed component. Use this when building custom feed layouts.
...
Automatically resumes playback from where the user previously stopped watching. Progress is saved every 2 seconds to localStorage per video. Resume is skipped if the saved position is within the first or last 5 seconds.
