...
<Callout type="tip">
    **See it in action:** Check out the [AutoPlay Background video](/en/sdk/examples/autoplay-background) for a complete background video autoplay implementation.
</Callout>
...
<Callout type="tip">
    **See it in action:** Check out the [Standard player video example](/en/sdk/examples/standard-player) for a complete standard video player implementation.
</Callout>
...
<Callout type="info">
  **Autoplay**: The SDK handles browser autoplay compliance automatically — just use `autoPlay={true}`. The video starts muted until the user interacts, and sound controls stay visible. Only add `muted={true}` for background videos where audio should be permanently disabled.
</Callout>
