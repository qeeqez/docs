...
<Callout type="info">
    Setting `muted={true}` permanently disables audio and hides the mute button and volume controls. This is ideal for feed components and custom UI implementations where you handle audio separately.
</Callout>
