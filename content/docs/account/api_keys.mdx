...
[//]: # (<!-- TODO: Add screenshot of project dashboard showing API Keys tab location -->)
...
[//]: # (<!-- TODO: Add screenshot of API keys list showing active keys with details -->)
...
<Steps>
    <Step>
        ...
        [//]: # (<!-- TODO: Add screenshot of Generate New Key button location -->)
    </Step>
    ...
    <Step>
        ...
        [//]: # (<!-- TODO: screenshot of API key configuration form with all settings -->)
    </Step>
    ...
    <Step>
        ...
        [//]: # (<!-- TODO: Add screenshot of one-time API key display with copy button -->)
    </Step>
</Steps>
