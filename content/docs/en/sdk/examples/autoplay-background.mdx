...
<div className="relative h-96 overflow-hidden rounded-xl mb-8">
  <Video
    className="absolute inset-0 w-fit h-fit object-contain"
    autoPlay={true}
    muted={true}
    loop={true}
...
<Callout type="info">
  <strong>Browser Autoplay:</strong> Always combine <code>autoPlay=&#123;true&#125;</code> with <code>muted=&#123;true&#125;</code> to ensure videos play automatically across all browsers.
</Callout>
