...
import {Video} from '@/components/rixl-player.tsx';
...
Now that you understand the standard video player, explore:

- **[Minimal Video Player](/en/sdk/examples/video/minimal-player)** - Simplified interface for clean designs
- **[Autoplay Background](/en/sdk/examples/video/autoplay-background)** - Hero section videos
- **[Video Gallery Carousel](/en/sdk/examples/video/video-carousel)** - Multiple video displays
- **[Props Reference](/en/sdk/video-component/props-reference)** - Complete API documentation
- **[Player Controls](/en/sdk/video-component/player-controls)** - Detailed control documentation