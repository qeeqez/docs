...
Need audio or controls? Use the [Standard Video Player](/en/sdk/examples/video/standard-player) instead.

## What's Next?

- **[Standard Video Player](/en/sdk/examples/video/standard-player)** - Full controls and audio
- **[Autoplay Background](/en/sdk/examples/video/autoplay-background)** - Hero section videos
- **[Feed Component](/en/sdk/feed-component/overview)** - Complete Feed implementation