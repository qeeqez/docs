...
<Columns cols={2}>
  <Card title="Project Separation" icon="folder-plus">
    Create separate projects for different campaigns, brands, or environments
    (dev/staging/prod).
  </Card>
  <Card title="Server Location" icon="globe">
    Choose server regions closest to your primary audience for optimal delivery
    performance.
  </Card>
</Columns>
...
<Columns cols={2}>
  <Card title="Alt Text" icon="eye">
    Always provide descriptive alt text for images and meaningful titles for
    videos.
  </Card>
...
<Callout type="warning">
  API keys are like passwords for your project. Keep them secure and never share them publicly or commit them to version
  control.
</Callout>
...
<Columns cols={3}>
  ...
  <Card title="Optimize Placeholders" icon="image">
    Use smart placeholders to improve perceived load time and prevent layout
    shift.
  </Card>
</Columns>
...
<Callout type="tip">
  Ready to put these practices into action? Start with the
  [5-Minute Quick Start Guide](/getting-started/quick-start) or explore the
  [Platform Dashboard Guide](/platform/dashboard/guide) for more in-depth
  workflows.
</Callout>