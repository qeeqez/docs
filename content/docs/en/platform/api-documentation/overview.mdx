...
<Callout type="tip" title="Ready to integrate?">
  First, <a href="/platform/api-documentation/create-key" className="underline">grab your API keys</a> and <a href="/platform/dashboard/projects/overview" className="underline">set up a project</a>. Then you're just a few lines of code away from optimized media delivery.
</Callout>
