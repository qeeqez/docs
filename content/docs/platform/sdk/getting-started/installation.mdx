...
- Learn about [Video Component](/platform/sdk/video-component) properties and advanced features
- Explore [Image Component](/platform/sdk/image-component) optimization options
- Browse [SDK Overview](/platform/sdk) for complete documentation