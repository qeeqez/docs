...
Ready to start building? Head to the [Installation](/platform/sdk/getting-started/installation) guide to set up your first RIXL-powered media component.

**Quick Links:**
- [React SDK Installation](/platform/sdk/getting-started/installation) - Get up and running in minutes
- [Video Component](/platform/sdk/video-component) - Rich video player documentation
- [Image Component](/platform/sdk/image-component) - Optimized image display
- [SDK Overview](/platform/sdk) - Complete SDK documentation