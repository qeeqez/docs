...
Ready to start building? Head to the [Installation](/docs/platform/sdk/installation) guide to set up your first RIXL-powered media component.

**Quick Links:**
- [React SDK Installation](/docs/platform/sdk/installation) - Get up and running in minutes
- [Video Component](/docs/platform/sdk/video-component/) - Rich video player documentation
- [Image Component](/docs/platform/sdk/image-component/) - Optimized image display
- [Examples](/docs/platform/sdk/examples) - Real-world implementation examples