...
<Steps>
  ...
  <Step>
    **Enable 2FA in RIXL**
    - Go to [Security Settings](/platform/account-teams/security)
...
<Steps>
  <Step>
    Go to **[Security Settings](/platform/account-teams/security) → Password**
  </Step>
...
- **[API Key](/platform/api-documentation/create-key) Usage**: Notifications for developer key activity
...
- **[General Settings](/platform/account-teams/general-settings)** - Profile and account information
- **[API Access](/platform/api-documentation/create-key)** - Developer keys and security
- **[Membership](/platform/account-teams/membership)** - Organization security roles