...
Keep your RIXL account secure with multi-factor authentication, connected accounts for SSO, and session monitoring.
...
<Steps>
    ...
    <Step>
        **Enable 2FA in RIXL**
        - Go to [Security Settings](/docs/platform/account/security-settings)
...
<Steps>
    <Step>
        Go to **[Security Settings](/docs/platform/account/security-settings) → Password**
    </Step>
...
- **[API Key](/docs/platform/account/api-access) Usage**: Notifications for developer key activity
...
- **[General Settings](/docs/platform/account/general-settings)** - Profile and account information
- **[API Access](/docs/platform/account/api-access)** - Developer keys and security
- **[Membership](/docs/platform/account/membership)** - Organization security roles