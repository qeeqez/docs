...
<Steps>
    ...
    <Step>
        **Enable 2FA in RIXL**
        - Go to [Security Settings](/platform/account/security)
...
<Steps>
    <Step>
        Go to **[Security Settings](/platform/account/security) → Password**
    </Step>
...
- **[General Settings](/platform/account/general-settings)** - Profile and account information
- **[API Access](/platform/api-documentation/create-key)** - Developer keys and security
- **[Membership](/platform/account/membership)** - Organization security roles