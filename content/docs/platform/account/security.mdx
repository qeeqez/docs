...
<Steps>
    ...
    <Step>
        **Enable 2FA in RIXL**
        - Go to [Security Settings](/docs/account/security-settings)
...
<Steps>
    <Step>
        Go to **[Security Settings](/docs/account/security-settings) → Password**
    </Step>
...
- **[API Key](/docs/account/api-access) Usage**: Notifications for developer key activity
