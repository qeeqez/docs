...
<Steps>
    <Step>
        **Review Invitation Details:**
        ...
        - Review the organization's [profile](/platform/account/organizations/overview) and members
    </Step>
    ...
    <Step>
        **Immediate Access:**
        ...
        - The new organization appears in your [Membership list](/platform/account/membership)
...
<Steps>
    <Step>
        **Verify the Sender:**
        ...
        - Look up the [organization](/platform/account/organizations/overview)
...
2. Verify your email address in [General Settings](/platform/account/general-settings)
...
- **[Membership](/platform/account/membership)** - Manage current organization roles
- **[Organizations](/platform/account/organizations/overview)** - Create and manage organizations
- **[General Settings](/platform/account/general-settings)** - Update your contact information for invitations