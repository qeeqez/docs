...
<Steps>
    <Step>
        **Review Invitation Details:**
        ...
        - Review the organization's [profile](/docs/platform/account/organizations) and members
    </Step>
    ...
    <Step>
        **Immediate Access:**
        ...
        - The new organization appears in your [Membership list](/docs/platform/account/membership)
...
<Steps>
    <Step>
        **Verify the Sender:**
        ...
        - Look up the [organization](/docs/platform/account/organizations)
...
2. Verify your email address in [General Settings](/docs/platform/account/general-settings)
...
- **[General Settings](/docs/platform/account/general-settings)** - Update your contact information for invitations