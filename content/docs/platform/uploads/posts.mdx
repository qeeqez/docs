...
<Callout type="info">
    Feed posts require an existing feed. Learn about [creating feeds](/docs/platform/dashboard/feeds) if you haven't set one up yet.
</Callout>
...
- **`video_quality`** - For videos: "basic", "shorts", or "pro" (see [Quality Tiers](/docs/platform/uploads/video-processing/quality-tiers) for details)
