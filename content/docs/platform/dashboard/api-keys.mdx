...
Use **API keys** to securely connect your [RIXL project](/docs/platform/dashboard/project) with applications, workflows, or services.  
...
<Steps>
    <Step>
       ...
       In your [project dashboard](/docs/platform/dashboard/project), go to **Settings → API Keys → Create New Key**.
    </Step>
...
<Callout type="info">
Need help? See our [API troubleshooting guide](/docs/platform/account/api-access/error) or contact support.
</Callout>
