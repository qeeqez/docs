...
You can upload your media using the [RIXL dashboard](/docs/dashboard/overview) or connect directly with the [API](/docs/api-reference). RIXL will handle the processing and return optimized media that loads quickly and looks great everywhere.
...
<Callout type="tip" title="Ready to transform your media workflow?">
  Start with our [Quick Start Guide](/docs/dashboard/guide) to upload your first file,  
  or see [Account Setup](/docs/account) to invite your team and configure your workspace.
</Callout>
