...
import {Callout, Card} from "@/components/mdx";
...
<Card title="429 Too Many Requests">
...
<Callout type="error" title="Lost Keys Can't Be Found">
  If you lose an API key, we can't show it to you again. For security, we only show keys once when you create them. You
  need to delete the lost key and create a new one.
</Callout>
