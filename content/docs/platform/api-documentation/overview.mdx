...
<Callout type="tip" title="Ready to integrate?">
  First, [grab your API keys](/platform/api-documentation/create-key) and [set up a
  project](/platform/dashboard/projects/overview). Then you're just a few lines of code away from optimized media
  delivery.
</Callout>
