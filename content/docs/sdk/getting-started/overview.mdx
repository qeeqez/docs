...
Ready to start building? Head to the [Installation](/platform/sdk/installation) guide to set up your first RIXL-powered media component.

**Quick Links:**
- [React SDK Installation](/platform/sdk/installation) - Get up and running in minutes
...
- [Examples](/platform/sdk/examples) - Real-world implementation examples