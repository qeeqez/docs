...
Ready to start building? Head to the [Installation](/docs/sdk/installation) guide to set up your first RIXL-powered media component.

**Quick Links:**
- [React SDK Installation](/docs/sdk/installation) - Get up and running in minutes
- [Video Component](/docs/sdk/video-component/) - Rich video player documentation
- [Image Component](/docs/sdk/image-component/) - Optimized image display
- [Examples](/docs/sdk/examples) - Real-world implementation examples