...
Ready to start building? Head to the [Installation](/sdk/getting-started/installation) guide to set up your first RIXL-powered media component.

**Quick Links:**
- [React SDK Installation](/sdk/getting-started/installation) - Get up and running in minutes
- [Video Component](/sdk/video-component) - Rich video player documentation
- [Image Component](/sdk/image-component) - Optimized image display
- [SDK Overview](/sdk/getting-started) - Complete SDK documentation
