...
<Steps>
    <div>
        **Upload to Dashboard**
        ...
        Go to [dash.rixl.com](https://dash.rixl.com) and upload your video or image files
    </div>
    <div>
        **Get Media ID**
...
<Callout type="info">
    **TypeScript errors?**
    ...
    - Update your `@types/react` package if needed
</Callout>
...
- Learn about [Video Component](/sdk/react/video-component/overview) properties and advanced features
- Explore [Image Component](/sdk/react/image-component/overview) optimization options
- Browse [SDK Overview](/sdk) for complete documentation