...
The player supports multiple resolution levels:

- **Auto (Recommended)** - Automatic quality selection based on connection
- **720p** - High definition (recommended for most users)
- **432p** - Standard definition
- **252p** - Lower quality for slower connections
- **160p** - Minimum quality for very slow connections
- *(Additional languages available based on video)*
