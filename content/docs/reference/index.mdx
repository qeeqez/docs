...
<Columns cols={3}>
  ...
  <Card title="Image API" icon="image">
    Upload and optimize images with AVIF compression and responsive delivery.
  </Card>
...
<Columns cols={3}>
  ...
  <Card
    ...
    icon="image"
  >
    Optimized images with AVIF compression, lazy loading, and responsive sizing.
  </Card>
...
<Columns cols={3}>
  ...
  <Card title="Smart Caching" icon="database">
    Intelligent cache invalidation and edge optimization.
  </Card>
</Columns>
