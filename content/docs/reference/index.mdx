...
<div className="mt-12">
  <Callout type="tip" title="Ready to integrate?">
    Start with our [API Reference](/platform/api-documentation/overview) for REST endpoints, or explore [React SDK
    Components](/sdk/getting-started/overview) for frontend integration.
  </Callout>
</div>
