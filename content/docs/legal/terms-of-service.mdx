...
<Cards>
  <Card title="Account Creation" description="Requirements for creating an account">
  ...
  <Card title="Account Responsibility" description="Your obligations as an account holder">
...
<Tabs items={['Permitted Uses', 'Prohibited Activities']}>
  ...
  <Tab value="Prohibited Activities">
    **You may not use our Services to:**
    ...
    <Cards>
      <Card title="Illegal Content" description="Content that violates laws">
        - Upload, process, or distribute illegal, harmful, or infringing content
        - Violate any applicable laws or regulations
        - Facilitate illegal activities or purposes
      </Card>

      <Card title="Security Violations" description="Actions that compromise security">
      ...
      <Card title="Intellectual Property" description="Respect for IP rights">
        - Infringe on the intellectual property rights of others
        - Upload copyrighted content without authorization
        - Reverse engineer our proprietary technology
      </Card>

      <Card title="Commercial Violations" description="Unauthorized business activities">
...
<Tabs items={['Subscription Plans', 'Payment Processing', 'Usage & Billing']}>
  ...
  <Tab value="Payment Processing">
    **Payment Processing**
    ...
    <Cards>
      <Card title="Secure Processing" description="Your payment information is protected">
      ...
      <Card title="Billing Cycle" description="How and when you're charged">
        - Subscription fees are billed in advance on a monthly or annual basis
        - Billing occurs on the same date each cycle
        - Invoices are sent via email
      </Card>

      <Card title="Refund Policy" description="Our refund terms">
...
<Cards>
  <Card title="Service Disclaimer" description="No warranties provided">
  ...
  <Card title="Limitation of Damages" description="Types of damages excluded">
    **EXCLUDED DAMAGES**
  ...
  <Card title="Maximum Liability" description="Cap on our total liability">
    **LIABILITY CAP**
...
<Tabs items={['Termination by You', 'Termination by RIXL', 'Effect of Termination']}>
  <Tab value="Termination by You">
    **You may terminate your account at any time**
    ...
    <Cards>
      <Card title="Self-Service Cancellation" description="Cancel through your dashboard">
      ...
      <Card title="Support-Assisted Cancellation" description="Get help with cancellation">
  ...
  <Tab value="Termination by RIXL">
    **We may terminate or suspend your account if you:**
    ...
    <Cards>
      <Card title="Policy Violations" description="Breaches of our terms">
        - Violate these Terms or our Acceptable Use Policy
        - Engage in prohibited activities
        - Abuse our platform or services
      </Card>

      <Card title="Payment Issues" description="Billing and payment problems">
        - Fail to pay required fees
        - Use fraudulent payment methods
        - Dispute legitimate charges
      </Card>

      <Card title="Security Concerns" description="Threats to platform security">
  ...
  <Tab value="Effect of Termination">
    **Upon termination:**
    ...
    <Cards>
      <Card title="Immediate Effects" description="What happens right away">
        - Your access to our Services will cease
        - Active processing jobs may be stopped
        - API access will be revoked
      </Card>

      <Card title="Data and Content" description="What happens to your data">
      ...
      <Card title="Financial Obligations" description="Outstanding payments">
