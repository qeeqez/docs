...
<Banner variant="info">
  **Coming soon:** Advanced video processing will include AI-powered thumbnail generation and automated chapter
  detection, allowing for smarter preview selection and seamless navigation.
</Banner>

<Callout>
  Once [video upload](https://api.rixl.com/videos) is complete, RIXL encodes the file into various quality levels and
  adaptive streaming formats for reliable playback across all devices and network conditions.
</Callout>
...
<Columns cols={4}>
  <Card
    title="Codec: Opus"
  >128kbps, 48kHz for superior quality and compression</Card>
  <Card
    title="Segmentation"
  >6-second audio segments for low-latency delivery</Card>
  <Card
    title="Independent Streaming"
  >Audio served separately to optimize bandwidth usage</Card>
  <Card
    title="Other Support"
  >Opus encoding for superior audio quality and compression</Card>
</Columns>
...
<Columns cols={4}>
  ...
  >Preserves aspect ratios while targeting industry-standard resolutions</Card>
  <Card
    title="Frame Rate Intelligence"
  >Maintains native frame rates and optimizes for target platforms</Card>
  <Card
    title="HDR Processing"
  >Supports HDR with BT.2020 color space and 10-bit encoding</Card>
  <Card
    title="Adaptive Quality Ladders"
  >Generates multiple renditions even from low-resolution sources</Card>
</Columns>
...
<Columns cols={4}>
  ...
  >Fastest processing with universal compatibility</Card>
  <Card
    title="Resolution: Upload Highest Available"
  >Up to 4K for Pro tier, system scales down appropriately</Card>
  <Card
    title="Frame Rate: 30fps or 60fps"
  >Standard rates for optimal processing and compatibility</Card>
  <Card
    title="Audio: Opus Codec"
  >Best compatibility and quality for source material</Card>
</Columns>
