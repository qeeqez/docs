...
<Callout type="info">
    Feed posts require an existing feed. Learn about [creating feeds](/docs/dashboard/feeds) if you haven't set one up yet.
</Callout>
...
- **`video_quality`** - For videos: "basic", "shorts", or "pro" (see [Quality Tiers](/docs/uploads/video-processing/quality-tiers) for details)
