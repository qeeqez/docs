...
import { Tabs, Tab, InfoCard } from '../../../../components';
...
- Set up [processing status monitoring](/docs/uploads/video-processing/monitoring-status) to track upload progress
- Learn about [quality tiers](/docs/uploads/video-processing/quality-tiers) to optimize processing choices
- Review [supported formats](/docs/uploads/video-processing/supported-formats) for optimal compatibility
