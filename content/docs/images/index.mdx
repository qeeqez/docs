...
<Columns cols={3}>
  <Card title="AVIF Optimization" icon="zap">
...
<Columns cols={3}>
  ...
  <Card title="User-Generated Content" icon="users">
    Customer photos and reviews with automatic optimization and moderation.
  </Card>
  <Card title="Category Banners" icon="layout">
    Hero images and promotional banners optimized for all devices.
  </Card>
</Columns>
...
<Columns cols={3}>
  <Card title="Editorial Content" icon="file-text">
    News articles, blog posts, and magazine-style layouts with optimized images.
  </Card>
  ...
  <Card title="Social Platforms" icon="users">
    User profiles, posts, and feeds with automatic image optimization.
  </Card>
</Columns>
...
<Columns cols={3}>
  <Card
    ...
    icon="upload"
  >
    See AVIF optimization in action with our dashboard upload.
  </Card>
  <Card
