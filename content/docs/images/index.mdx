...
<div className="mt-12">
  <Callout type="tip" title="Ready to see the difference?">
    Start with our [Dashboard Upload](/platform/uploads/images) to see AVIF transformation in action, or jump into the
    [React Component Guide](/sdk/image-component) to add delivered images to your application. For custom workflows,
