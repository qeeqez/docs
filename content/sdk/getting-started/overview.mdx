...
Ready to start building? Head to the [Installation](/sdk/installation) guide to set up your first RIXL-powered media component.

**Quick Links:**
- [React SDK Installation](/sdk/installation) - Get up and running in minutes
...
- [Examples](/sdk/examples) - Real-world implementation examples