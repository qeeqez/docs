...
// import {PageTreeFolder} from "@/components/layout/docs/sidebar/sidebar-page-tree-folder"; // TODO FIX SIDEBAR
...
export function SidebarPageTree() {
  ...
  return useMemo(() => {
    function renderSidebarList(items: Node[], _level: number): ReactNode[] {
      return items.map((item, i) => {
        ...
        if (item.type === "folder") {
          ...
          return (
            <div key={i}></div> // TODO FIX SIDEBAR
